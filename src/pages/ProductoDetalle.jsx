...
const ProductoDetalle = () => {
    ...
    useEffect(() => {
        const fetchProducto = async () => {
            ...
            if (data?.variantes?.length > 0) {
                setColorSeleccionado(data.variantes[0])
    ...
    const handleAddToCart = () => {
        ...
        const precioNew = producto.poseeDescuento ? aplicarDescuento(producto.precio, producto.descuento) : producto.precio
        const product = {
            id: producto.id,
            ...
            <div className='grid grid-cols-2'>
                ...
                <div className='px-10 flex flex-col justify-between'>
                    <div>
                        ...
                        {/* Colores */}
                        <div>
                            <h2 className='text-xl font-semibold mb-2'>Colores disponibles:</h2>
                        ...
                        {colorSeleccionado && (
                            <div className="mt-4">
                                <h2 className='text-xl font-semibold mb-2'>Talles disponibles:</h2>
                    ...
                    <div className='h-30 flex flex-col gap-5 mt-6'>
                        <p>¡Stock disponible por color/talle!</p>
                        <button
